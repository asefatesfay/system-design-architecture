...
def create_university_agent(profile_name='default'):
    ...
    # Set AWS profile and other environment variables
    os.environ["AWS_PROFILE"] = profile_name
    os.environ["KNOWLEDGE_BASE_ID"] = KNOWELEDGE_BASE_ID
...
def main():
    parser = argparse.ArgumentParser(description='University Chatbot powered by AWS Bedrock')
    ...
    print(f"\nUsing AWS profile: {args.profile_name}")
    print("\nType 'quit' to exit.\n")

    agent = create_university_agent(profile_name=args.profile_name)
